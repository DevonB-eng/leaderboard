...
class WeeklyChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxY = allValues.isEmpty
        ? 100.0
        : (allValues.reduce((a, b) => a > b ? a : b) * 1.2).clamp(10.0, double.infinity);
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text('WEEKLY SCREENTIME', style: AppTextStyles.heading()),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Container(width: 12, height: 12, color: AppColors.primaryBright),
                                ...
                                sideTitles: SideTitles(
                                  ...
                                  getTitlesWidget: (value, meta) {
                                    ...
                                    return Padding(
                                      ...
                                      child: Text(dayLabels[i], style: AppTextStyles.label()),
                                    );
                                  },
                                  reservedSize: 28,
                                ),
